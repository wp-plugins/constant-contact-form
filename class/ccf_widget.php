<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/constant-contact-form/class/ccf_ajax.js"></script>
<link rel="stylesheet" media="screen" type="text/css" href="<?php echo get_option('siteurl'); ?>/wp-content/plugins/constant-contact-form/class/ccf_custom.css" />
