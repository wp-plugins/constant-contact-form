...
function ccf_activation()
{
	...
	add_option('ccf_adminemail', "admin@gopipulse.com");
	add_option('ccf_fromemail', "noreply@gopipulse.com");
...
function ccf_control() 
{
	...
	echo 'click here</a></p>';
	echo 'Check official website for live demo <a target="_blank" href="http://www.gopipulse.com/work/2010/07/18/constant-contact/">click here</a>';
}
